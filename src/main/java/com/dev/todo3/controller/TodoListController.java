...
public class TodoListController {
    ...
    @PutMapping("/tasks/{taskId}/s/{statusid}")
    public ResponseEntity<Task> updateTaskStatus(@PathVariable Long taskId, @PathVariable Long statusid) {
        Task updatedTask = todoListService.updateTaskStatus(taskId, statusid);
        return ResponseEntity.ok(updatedTask);
    }

    @PutMapping("/tasks/{taskId}/p/{priorityid}")
    public ResponseEntity<Task> updateTaskPriority(@PathVariable Long taskId, @PathVariable Long priorityid) {
        Task updatedTask = todoListService.updateTaskPriority(taskId, priorityid);
        return ResponseEntity.ok(updatedTask);
    }
    ...
    public ResponseEntity<Void> deleteTaskFromList( @PathVariable Long listId, @PathVariable Long taskId) {
        System.out.println("Entrou no deleteTaskFromList");
